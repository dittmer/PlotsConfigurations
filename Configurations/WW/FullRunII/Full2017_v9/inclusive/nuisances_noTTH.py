...
sfdict = json.load(open("%s/WW/FullRunII/Full2017_v9/inclusive/sampleFrac_noTTH.json"%configurations))
...
nuisances['PU'] = {
    ...
    'samples': {
        ...
        'Higgs'   : ['1.001963*(puWeightUp/puWeight)', '0.998288*(puWeightDown/puWeight)'],
    },
    'AsLnN': '0',
}
